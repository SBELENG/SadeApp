...
Base de datos inmutable embebida en `constants/indices.ts`. Esta base de datos representa la fuente de verdad oficial según el Anexo 1 UNRC y cuenta con el atributo `nivel_minimo` (2 o 3) de complejidad institucional para el filtrado en el selector de la Pantalla 1.

#### Tabla A — Especialidades médicas (horas enfermera-paciente en 24hs)
| Especialidad | De | A | Perfil | Nivel Mínimo |
| :--- | :--- | :--- | :--- | :--- |
| Alergología e Inmunología | 3.0 | 3.4 | EG | 2 |
| Cardiología | 3.0 | 3.4 | EG | 2 |
| Dermatología | 3.0 | 3.4 | EG | 2 |
| Endocrinología | 3.0 | 3.4 | EG | 2 |
| Hematología | 4.0 | 4.8 | EG | 2 |
| Infectología | 4.0 | 4.8 | EG | 2 |
| Medicina Interna | 4.0 | 4.8 | EG | 2 |
| Nefrología | 3.0 | 4.8 | EG | 2 |
| Neumología | 3.0 | 3.4 | EG | 2 |
| Neurología | 3.4 | 4.8 | EG | 2 |
| Oncología | 3.4 | 4.0 | EG | 2 |
| Psiquiatría | 3.4 | 4.0 | EG | 2 |
| Reumatología | 3.4 | 4.0 | EG | 2 |
| Ginecología | 3.0 | 3.4 | EG | 2 |
| Obstetricia | 3.0 | 3.4 | EG | 2 |
| Perinatología | 8.0 | 12.0 | EG | 2 |
| Alojamiento conjunto | 3.4 | 4.0 | EG | 2 |

#### Tabla B — Especialidades quirúrgicas (horas enfermera-paciente en 24hs)
| Especialidad | De | A | Perfil | Nivel Mínimo |
| :--- | :--- | :--- | :--- | :--- |
| Cirugía de cabeza y cuello | 3.0 | 3.4 | EG | 2 |
| Cirugía cardiovascular | 4.0 | 4.8 | EG | 2 |
| Cirugía general | 3.4 | 4.0 | EG | 2 |
| Cirugía plástica y reconstructiva | 3.0 | 3.8 | EG | 2 |
| Gastrocirugía | 3.4 | 4.8 | EG | 2 |
| Neurocirugía | 3.4 | 4.0 | EG | 2 |
| Oftalmología | 3.0 | 3.4 | EG | 2 |
| Otorrinolaringología | 3.0 | 3.8 | EG | 2 |
| Oncocirugia | 4.0 | 4.8 | EG | 2 |
| Traumatología y ortopedia | 4.0 | 4.8 | EG | 2 |
| Proctología | 3.4 | 4.0 | EG | 2 |
| Urología | 3.4 | 4.0 | EG | 2 |
| Vascular periférico (Angiología) | 3.4 | 4.0 | EG | 2 |
| Ginecología quirúrgica | 3.0 | 3.4 | EG | 2 |
| Obstetricia quirúrgica | 3.0 | 3.4 | EG | 2 |
| Perinatología quirúrgica | 8.0 | 12.0 | EG | 2 |
...
| Especialidad | De | A | Perfil | Nivel Mínimo |
| :--- | :--- | :--- | :--- | :--- |
| Cardiología pediátrica | 4.5 | 4.8 | EG | 2 |
| Cuidados intensivos pediátricos | 8.0 | 12.0 | EE | 3 |
| Cunero fisiológico | 3.0 | 3.4 | EG | 2 |
| Gastroenterología pediátrica | 4.0 | 4.8 | EG | 2 |
| Hematología pediátrica | 4.0 | 4.8 | EG | 2 |
| Infectología pediátrica | 4.0 | 4.8 | EG | 2 |
| Nefrología pediátrica | 4.5 | 4.8 | EG | 2 |
| Neonatología | 8.0 | 12.0 | EE | 3 |
| Neumología pediátrica | 4.0 | 4.8 | EG | 2 |
| Neurología pediátrica | 4.0 | 4.8 | EG | 2 |
| Neurocirugía pediátrica | 4.0 | 4.8 | EG | 2 |
| Oftalmología pediátrica | 3.4 | 4.0 | EG | 2 |
| Oncología pediátrica | 4.5 | 4.8 | EG | 2 |
| Otorrinolaringología pediátrica | 3.4 | 3.8 | EG | 2 |
| Pediatría general | 4.0 | 4.8 | EG | 2 |
| Prematuros | 5.0 | 8.0 | EG | 2 |
| Psiquiatría pediátrica | 4.0 | 4.8 | EG | 2 |
| Traumatología y ortopedia pediátrica | 4.0 | 4.8 | EG | 2 |
| Urología pediátrica | 4.0 | 4.8 | EG | 2 |
...
| Área | Estándar mínimo (De) | Estándar máximo (A) | Nivel Mínimo |
| :--- | :--- | :--- | :--- |
| Central de equipos y esterilización | 1 AE/40 camas + 1 EG/100 camas | 1 AE/30 camas + 1 EG/80 camas | 3 |
| Cirugía ambulatoria | 1 AE/6 camas + 1 EG/15 camas | 1 AE/6 camas + 1 EG/10 camas | 3 |
| Hemodinámica | 1 EG/sala | 2 EG/sala | 3 |
| Radiología intervencionista | 1 AE/turno | 2 AE/turno | 3 |
| Recuperación | 1 EG/8 camillas + 1 EE/10 camillas | 1 EG/6 camillas + 1 EE/8 camillas | 2 |
| Sala de quirófano | 1 EE + 1 EG/sala | 2 EE + 1 EG/sala | 2 |
| Tococirugía — Admisión | 1 AE/consultorio | 1 EG/consultorio | 2 |
| Tococirugía — Labor | 1 EG/6 camas + 1 EE/12 camas | 1 EG/6 camas + 1 EE/10 camas | 2 |
| Tococirugía — Expulsión | 1 EG/sala | 1 EE/sala | 2 |
| Tococirugía — Puerperio bajo riesgo | 1 EG/10 camillas | 1 EG/6 camillas | 2 |

#### Tabla E — Áreas críticas por ratio de perfil (NO usan fórmula P = I×C/J)
| Área | Estándar mínimo (De) | Estándar máximo (A) | Nivel Mínimo |
| :--- | :--- | :--- | :--- |
| Cuidados intensivos adultos | 1 EE/2 camas | 1 EE/cama | 3 |
| Cuidados intensivos neonatología | 1 EE/2 camas | 1 EE/cama | 3 |
| Cuidados intensivos pediatría | 1 EE/2 camas | 1 EE/cama | 3 |
| Terapia intermedia adultos | 1 EE/3 camas | 1 EE/2 camas | 3 |
| Terapia intermedia pediatría | 1 EE/3 camas | 1 EE/2 camas | 3 |
| Unidad de choque adultos | 1 EE/unidad | 2 EE/unidad | 3 |
| Unidad de choque pediatría | 1 EE/unidad | 2 EE/unidad | 3 |
| Unidad de choque traumatología | 1 EE/unidad | 2 EE/unidad | 3 |
| Unidad de quemados adultos | 1 EE/unidad | 2 EE/unidad | 3 |
| Unidad de quemados pediatría | 1 EE/unidad | 1 EE/unidad | 3 |
| Unidad de trasplantes | 1 EE/unidad | 2 EE/unidad | 3 |
| Urgencias adultos | 1 EG/3 camas | 1 EE/3 camas | 3 |
| Urgencias coronarias | 1 EE/2 camas | 1 EE/cama | 3 |
| Urgencias pediátricas | 1 EE/3 camas | 1 EE/2 camas | 3 |

#### Tabla F — Consulta externa por ratio de perfil (NO usan fórmula P = I×C/J)
| Área | Estándar mínimo (De) | Estándar máximo (A) | Nivel Mínimo |
| :--- | :--- | :--- | :--- |
| Admisión hospitalaria | 1 AE/turno | 1 EG/turno | 2 |
| Curaciones | 1 EG/cubículo | 1 EG + 1 AE/cubículo | 2 |
| Clínica de catéteres | 1 EG/turno | 2 EG/turno | 2 |
| Clínica del dolor | 1 EG/turno | 2 EG/turno | 2 |
| Clínica de estomas | 1 EG/turno | 2 EG/turno | 2 |
| Consultorios de especialidades | 1 AE/2 consultorios | 1 AE/consultorio | 2 |
| Endoscopías | 1 EG/sala | 1 EE/sala | 2 |
| Hemodiálisis adulto | 1 EE/2 máquinas | 1 EE/2 máquinas | 2 |
| Hemodiálisis pediatría | 1 EE/máquina | 2 EE/máquina | 2 |
| Quimioterapia | 1 EG/8 tratamientos | 1 EE/8 tratamientos | 2 |
| Servicios de diagnóstico | 1 AE/turno | 1 AE/turno | 2 |
| Sala de altas | 1 AE/turno | 1 EG/turno | 2 |
...
*   **UI/UX:**
    *   **Dropdown de Servicio / Especialidad Agrupado (optgroups):** El selector de servicio reemplaza las 9 opciones anteriores y se nutre completamente de las Tablas A, B, C, D, E y F, organizadas visualmente en los siguientes grupos:
        *   *Clínicas (Tabla A):* 17 especialidades (todas con `nivel_minimo` = 2).
        *   *Quirúrgicas (Tabla B):* 16 especialidades (todas con `nivel_minimo` = 2).
        *   *Pediátricas (Tabla C):* 19 especialidades (todas con `nivel_minimo` = 2, excepto Cuidados Intensivos Pediátricos y Neonatología que poseen `nivel_minimo` = 3).
        *   *Áreas quirúrgicas por ratio (Tabla D):* 10 áreas (marcadas con `tipo_calculo = 'ratio'`. Sala de quirófano, Recuperación y Tococirugía poseen `nivel_minimo` = 2; el resto posee `nivel_minimo` = 3).
        *   *Áreas críticas por ratio (Tabla E):* 14 áreas (marcadas con `tipo_calculo = 'ratio'`. Todas con `nivel_minimo` = 3).
        *   *Consulta externa por ratio (Tabla F):* 12 áreas (marcadas con `tipo_calculo = 'ratio'`. Todas con `nivel_minimo` = 2).
    *   **Filtrado Reactivo por Nivel de Complejidad:**
        *   Al seleccionar el Nivel de Complejidad de la institución (2do vs 3er Nivel) mediante los radio buttons, el dropdown de especialidades se filtra dinámicamente mostrando solo aquellas cuyo atributo `nivel_minimo` sea menor o igual al seleccionado (ej: en Complejidad Nivel 2 se ocultan todas las áreas críticas de la Tabla E y los cuidados pediátricos críticos).
        *   *Limpieza de optgroups vacíos:* Si a causa del filtrado por nivel un grupo queda completamente vacío, dicho grupo (`optgroup`) no debe mostrarse en absoluto en la UI del dropdown.
        *   *Control de Inconsistencia por Cambio de Nivel:* Si el administrador cambia el nivel de complejidad institucional a uno menor después de haber seleccionado una especialidad que solo está disponible para un nivel superior, el campo de especialidad seleccionada se limpia automáticamente y muestra la advertencia: *"La especialidad seleccionada no está disponible para este nivel de complejidad."*
    *   **Comportamiento Dinámico de los Campos de Entrada:**
        *   Al seleccionar cualquier especialidad estándar de las Tablas A, B o C, el sistema autocompleta el rango de índice `I` (mínimo y máximo) en un Slider interactivo para configurar el valor exacto de `I`, e introduce la cantidad de camas (`C`).
        *   *Lógica Condicional (Servicios por Ratio - Tablas D, E y F):* Cuando el usuario selecciona un servicio con `tipo_calculo = 'ratio'`, los campos tradicionales de "Índice I" y "Camas" se ocultan por completo de la pantalla. En su lugar, se renderizan:
            1.  *Ratio mínimo* y *Ratio máximo* (campos de solo lectura, cargados desde la base de datos de especialidades).
            2.  *Cantidad de unidades* (input numérico editable mayor o igual a 1 donde el usuario ingresa salas, máquinas, consultorios, etc. sobre las que se aplica el ratio).
            El botón "Calcular Dotación" en estos casos no ejecuta la fórmula $P = (I \times C) / J$, sino que calcula y muestra directamente el perfil requerido multiplicando el ratio configurado por la cantidad de unidades ingresada.
    *   Input numérico para la cantidad de camas activas (`C`) (solo visible para servicios tipo `indice`).
...
11. **CAMBIO 11 — Actualizar el dropdown de Servicio/Especialidad en Pantalla 1 (Fase 2):**
    *   *Ubicación:* Sección 10, Pantalla 1.
    *   *Modificación:* Reemplazo del selector simple de 9 opciones con el agrupamiento en optgroups de las Tablas A a F, introduciendo autocompletado del rango de índice `I` para especialidades tradicionales (Tablas A, B, C) y renderizado alternativo de ratios/unidades para áreas por ratio (Tablas D, E, F).
    *   *Justificación:* Ofrecer una navegación estructurada y completa de todos los servicios del Anexo 1 UNRC.
12. **CAMBIO 12 — Filtrado del dropdown por nivel de complejidad (Fase 2):**
    *   *Ubicación:* Sección 05 (Base de datos de índices con la columna `nivel_minimo`) y Sección 10, Pantalla 1 (Lógica de filtrado reactivo).
    *   *Modificación:* Asignación de nivel mínimo (2 o 3) a cada especialidad/área y filtrado dinámico del dropdown. Se limpia la especialidad seleccionada mostrando advertencia si cambia el nivel de complejidad institucional a uno no admitido.
    *   *Justificación:* Evitar la asignación o cálculo de dotaciones para áreas que excedan la complejidad legal de la institución.
13. **CAMBIO 13 — Ocultación de grupos vacíos por filtrado en dropdown (Fase 2):**
    *   *Ubicación:* Sección 10, Pantalla 1.
    *   *Modificación:* Ocultación inteligente de grupos (`optgroups`) completos en la interfaz del dropdown cuando el filtrado por nivel de complejidad los deja vacíos.
    *   *Justificación:* Ofrecer una interfaz limpia y libre de secciones vacías para optimizar la usabilidad administrativa.
